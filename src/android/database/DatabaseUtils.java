...
public class DatabaseUtils {
    ...
    public static class InsertHelper {
        ...
        private void buildSQL() throws SQLException {
            ...
            sLog.trace("insert statement is " + mInsertSQL);
        }
        ...
        private long insertInternal(ContentValues values, boolean allowReplace) {
            ...
            try {
                ...
                stmt.clearBindings();
                sLog.trace("--- inserting in table " + mTableName);
                for (Map.Entry<String, Object> e: values.valueSet()) {
                    final String key = e.getKey();
                    int i = getColumnIndex(key);
                    DatabaseUtils.bindObjectToProgram(stmt, i, e.getValue());
                    sLog.trace("binding " + e.getValue() + " to column " +
                              i + " (" + key + ")");
                }
                ...
                sLog.error("Error inserting " + values + " into table  " + mTableName, e);
                return -1;
            } finally {
                mDb.endTransaction();
            }
        ...
        public long execute() {
            ...
            try {
                sLog.trace("--- doing insert or replace in table " + mTableName);
                return mPreparedStatement.executeInsert();
            } catch (SQLException e) {
                sLog.error("Error executing InsertHelper with table " + mTableName, e);
                return -1;
            } finally {
     ...
     *   semicolons)
     */
    /* Do we actually need this? It's quite broken...
