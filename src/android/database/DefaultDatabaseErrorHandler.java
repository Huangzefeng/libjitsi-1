...
public final class DefaultDatabaseErrorHandler implements DatabaseErrorHandler {
    ...
    private static final Logger sLog = Logger.getLogger(DefaultDatabaseErrorHandler.class);
    ...
    public void onCorruption(SQLiteDatabase dbObj) {
        sLog.error("Corruption reported by sqlite on database: " + dbObj.getPath());
    ...
    private void deleteDatabaseFile(String fileName) {
        ...
        sLog.error("deleting the database file: " + fileName);
        try {
            SQLiteDatabase.deleteDatabase(new File(fileName));
        } catch (Exception e) {
            /* print warning and ignore exception */
            sLog.warn("delete failed: " + e.getMessage());
        }
    }
}
