...
public final class SQLiteDatabase extends SQLiteClosable {
    private static final Logger sLog = Logger.getLogger(SQLiteDatabase.class);
     ...
     */
    void onCorruption() {
        sLog.error(EVENT_DB_CORRUPT + getLabel());
    ...
    private void open() {
        try {
            ...
            sLog.error("Failed to open database '" + getLabel() + "'.", ex);
            close();
            throw ex;
        }
    }
    ...
    public long insert(String table, String nullColumnHack, ContentValues values) {
        try {
            ...
            sLog.error("Error inserting " + values, e);
            return -1;
        }
    }
    ...
    public long replace(String table, String nullColumnHack, ContentValues initialValues) {
        try {
            ...
            sLog.error("Error inserting " + initialValues, e);
            return -1;
        }
    }
    ...
    public boolean enableWriteAheadLogging() {
        synchronized (mLock) {
            ...
            if (mConfigurationLocked.isInMemoryDb()) {
                sLog.info("can't enable WAL for memory databases.");
                return false;
            }
            ...
            if (mHasAttachedDbsLocked) {
                sLog.trace("this database: " + mConfigurationLocked.label
            ...
            for (int i = 0; i < attachedDbs.size(); i++) {
                ...
                try {
                    ...
                    if (!rslt.equalsIgnoreCase("ok")) {
                        ...
                        sLog.error("PRAGMA integrity_check on " + p.second + " returned: " + rslt);
                        return false;
                    }
                } finally {
