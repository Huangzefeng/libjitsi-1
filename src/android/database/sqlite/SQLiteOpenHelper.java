...
public abstract class SQLiteOpenHelper {
    private static final Logger sLog = Logger.getLogger(SQLiteOpenHelper.class);
     ...
     */
    public SQLiteOpenHelper(String name, CursorFactory factory, int version) {
        this(name, factory, version, null);
    }
        ...
        try {
            ...
            if (db != null) {
                ...
                try {
                    ...
                    db = SQLiteDatabase.openDatabase(mName, mFactory, flags, mErrorHandler);
                } catch (SQLiteException ex) {
                    if (writable) {
                        throw ex;
                    }
                    sLog.error("Couldn't open " + mName
                            + " for writing (will try read-only):", ex);

                    db = SQLiteDatabase.openDatabase(mName, mFactory,
            ...
            if (db.isReadOnly()) {
                sLog.warn("Opened " + mName + " in read-only mode");
            }
