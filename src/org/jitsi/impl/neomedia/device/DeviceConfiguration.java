    ...
    implements PropertyChangeListener
{
    ...
    private static final String[] CUSTOM_RENDERERS
        = new String[]
        {
            ...
            (OSUtils.IS_ANDROID ||
                OSUtils.IS_WINDOWS_7 ||
                    OSUtils.IS_WINDOWS_8) ? null : ".audio.MacCoreaudioRenderer",
            ".video.JAWTRenderer"
        };
...
//                }
    ...
    public CaptureDeviceInfo2 getAudioCaptureDevice()
    {
        ...
        return
            (audioSystem == null)
                ? null
                : audioSystem.getAndRefreshSelectedDevice(AudioSystem.DataFlow.CAPTURE);
    }
    ...
    public CaptureDeviceInfo getAudioNotifyDevice()
    {
        ...
        return
            (audioSystem == null)
                ? null
                : audioSystem.getAndRefreshSelectedDevice(AudioSystem.DataFlow.NOTIFY);
    }
