    ...
    extends java.util.logging.Formatter
{
    ...
    public synchronized String format(LogRecord record)
    {
        ...
        sb.append(fourDigFmt.format(year)).append('_');
        sb.append(twoDigFmt.format(month)).append('_');
    ...
    /**
     * @return the class name associated with this log formatter
     */
    protected String getClassName()
    {
        return "net.java.sip.communicator.util.Logger";
    }
}
